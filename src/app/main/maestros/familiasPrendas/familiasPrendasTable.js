...
import {
	getFamliasPrenda,
	removeFamliasPrendas,
	selectFamiliasPrendas,
} from '../store/familia-prenda/familiasPrendasSlice';
import FamiliasPrendasTableHead from './familiasPrendasTableHeader';
// import EmpresaTableHead from './empresasTableHeader';

function FamiliasPrendasTable(props) {
	const dispatch = useDispatch();
	const navigate = useNavigate();
	const famliiasPrendas = useSelector(selectFamiliasPrendas);
	const totalFamliasPrendas = useSelector(({ maestros }) => maestros.familiasPrenda.total);
	const searchText = useSelector(({ maestros }) => maestros.familiasPrenda.searchText);

	const [loading, setLoading] = useState(true);
	const [selected, setSelected] = useState([]);
	const [data, setData] = useState(famliiasPrendas);
	...
	function handleClick(item) {
		navigate(`/maestros/familias-prendas/${item.id}`);
	}
...
export default withRouter(FamiliasPrendasTable);
