...
import { setUnidadesSearchText } from '../store/unidad/unidadesSlice';

function UnidadesHeader(props) {
	...
	return (
		<div className="flex flex-1 w-full items-center justify-between">
				...
				<ThemeProvider theme={mainTheme}>
					...
					>
						...
						<Input
							...
							onChange={ev => {
								dispatch(setUnidadesSearchText(ev));
							}}
						/>
					</Paper>
				</ThemeProvider>
			...
			>
				<Button
					component={Link}
					to="/configuracion/unidades/nuevo"
