...
import {
	...
	newSalida,
	resetSalida,
} from '../../../store/almacenTela/salidas/salidaTelaSlice';
...
const Salidas = () => {
	...
	const salida = useSelector(({ almacen }) => almacen.salida);

	const routeParams = useParams();
	const [tabValue, setTabValue] = useState(0);
	const [noExisteSalida, setNoExisteSalida] = useState(false);
