...
import {
	getReporteOp,
	resetTabla,
	selectReporteOpTelas,
} from 'app/main/almacen/store/almacenTela/reporteOp/reporteOpTelasSlice';
...
function ReporteOpTable(props) {
	...
	console.log('render reporteOpTable.js');

	const dispatch = useDispatch();
	const navigate = useNavigate();
	const model = useSelector(selectReporteOpTelas);
	const total = useSelector(({ almacen }) => almacen.reporteOp.total);
	const searchText = useSelector(({ almacen }) => almacen.reporteOp.searchText);
