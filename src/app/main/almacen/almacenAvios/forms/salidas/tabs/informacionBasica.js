...
function InformacionBasica() {
	...
	const [produccionesSearchText, setProduccionesSearchText] = useState('');
	const [muestraSearchText, setMuestraSearchText] = useState('');
	...
	const traerIdNota = async () => {
		const url = `almacen-avio/salida/generateNota`;
										...
										render={({ field: { onChange, value } }) => {
											...
											return (
												<Autocomplete
													...
													onInputChange={(event, newInputValue) => {
														setProduccionesSearchText(newInputValue);
													}}
													fullWidth
													onChange={(event, newValue) => {
														if (newValue) {
										...
										render={({ field: { onChange, value } }) => {
											...
											return (
												<Autocomplete
													...
													onInputChange={(event, newInputValue) => {
														setMuestraSearchText(newInputValue);
													}}
													fullWidth
													onChange={(event, newValue) => {
														if (newValue) {
