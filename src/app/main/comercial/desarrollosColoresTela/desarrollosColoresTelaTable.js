...
import {
	getDesarrollosColoresTela,
	removeDesarrollosColoresTela,
	selectDesarrollosColoresTela,
} from '../store/desarrolloColorTela/desarrollosColoresTelaSlice';
...
function Tabla(props) {
	...
	const dataModel = useSelector(selectDesarrollosColoresTela);
	const total = useSelector(({ comercial }) => comercial.desarrollosColoresTela.total);
	const searchText = useSelector(({ comercial }) => comercial.desarrollosColoresTela.searchText);
	...
	const onClickEditar = item => {
		navigate(`/comercial/desarrollo-color-tela/${item.id}`);
	};
		...
		return (
			...
			>
				<Typography color="textSecondary" variant="h5">
					No hay desarrollos de colores para telas!
				</Typography>
			</motion.div>
		);
	}
