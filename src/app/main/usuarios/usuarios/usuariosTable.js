...
import { getUsuarios, removeUsuarios, selectUsuarios } from '../store/usuario/usuariosSlice';
import UsuariosTableHead from './usuariosTableHeader';
...
function UsuariosTable(props) {
	...
	const totalUsuarios = useSelector(({ usuarios }) => usuarios.usuarios.total);
	// eslint-disable-next-line no-shadow
	const searchText = useSelector(({ usuarios }) => usuarios.usuarios.searchText);
